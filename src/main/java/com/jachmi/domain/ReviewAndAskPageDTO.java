...
@Data
public class ReviewAndAskPageDTO {
	private int startPage;	// 시작 페이지 번호0
	private int endPage;	// 끝 페이지 번호
	private boolean prev, next;	// 이전, 다음 페이지 이동
	private int total;	// 전체 게시물 수
	private ReviewAndAskCreteriaVO cri;
	
	// 페이지 번호를 10개씩 본다는 가정
	public ReviewAndAskPageDTO(ReviewAndAskCreteriaVO cri, int total) {
		this.cri = cri;
		this.total = total;
