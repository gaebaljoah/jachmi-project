...
<h2 style="text-align: center; margin: 0;">회원가입</h2>
	  ...
	  <form action="" method="POST" id="joinform">
            ...
            <div class="input-box">
             ...
             <div class="input-box">
                 <input id="birth" type="text" name="birth" placeholder="성별" readonly="readonly">
...
function findAddr() {
	...
	$(".join").click(function(e){
		...
		if(f.name.value == '' || f.id.value == '' || f.password.value == '' || f.password2.value == '' || 
				f.birth.value == '' || f.gender.value == '' || f.phone.value == '' || 
				f.email.value == '' || f.c_main_address.value == '' || f.addr_ck.value == '') {
			alert("모든 정보를 입력해주세요.");
		}else{
