...
<style type="text/css">
   #wrap {position:relative;padding-bottom:100px}
   #footer {position:absolute; bottom:0; left:0; right:0; color : white; text-align: center;}
	#p{margin: 13px;}
</style>
</head>
<body>
   <!--하단  -->
	 <div id="wrap">
         ...
         <footer id="footer">  <p id="p">상호명 : 자취미생활 대표자명 : ㅇㅇㅇ 주소 :서울 금천구 디지털로9길 56 사업자등록번호:123-45-67890  TEL :012-4567-8989 FAX: 012-333-4444
      <br>COMPANYⓒMANDO.RIGHTS RESERVED.</p></footer>
      </div>
